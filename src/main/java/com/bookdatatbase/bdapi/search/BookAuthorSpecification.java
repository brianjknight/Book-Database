...
@Slf4j
@AllArgsConstructor
public class BookAuthorSpecification<T> implements Specification<T> {

    @Serial
    private static final long serialVersionUID = -7262551397051411835L;
...
//        Double avgRat = (Double) request.getFilters().get(0).getValue();
//        Join<Book, Author> join = root.join("author");
//        predicate = cb.and(cb.greaterThan(join.get("averageRating"), avgRat), predicate);
