...
I often find myself using Google searches such as "best space sci-fi books all-time" or "top tech thriller books of the last 15 years". 
I end up spending a lot of time browsing lists from different sources (e.g. subjective recommendations on an individual's blog post) unable to make a decision. 
